...
const buttonVariants = cva(
    "flex flex-row items-center justify-center rounded-lg font-sans text-base leading-6 text-center transition-all duration-200 select-none active:scale-95 cursor-pointer",
    {
        variants: {
            variant: {
